...
% and the number of performance claps not found in truth (coeffs(2))
...
nZerT = find(truth);
% finds the number of truth claps not found in performance (coeffs(3))
for ii = 1:sum(truth)
...
% correct claps / total claps (with adjustments for tolerances)
